    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <span className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-semibold border
            ${connectionStatus === 'online' ? 'bg-emerald-50 text-emerald-700 border-emerald-200' : 
      ...
      {/* FOOTER METRICS */}
      <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-wrap gap-6 items-center text-sm">
