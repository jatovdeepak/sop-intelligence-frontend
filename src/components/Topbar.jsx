...
export default function Topbar() {
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-black/10 bg-white px-6 shadow-sm">
      ...
      <input
        className="w-96 rounded-lg bg-slate-100 px-4 py-2 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 border-l border-slate-200 pl-4">
          ...
          <button
            ...
            className="ml-2 rounded-md bg-slate-100 px-3 py-1.5 text-xs font-medium text-slate-600 transition-colors hover:bg-red-50 hover:text-red-600"
          >
            Logout
          </button>
        </div>
